...
const PromotionReactivatorModel = mongoose.model<IPromotionReactivator, mongoose.Model<IPromotionReactivator>>('PromotionReactivator', promotionReactivatorModel);
