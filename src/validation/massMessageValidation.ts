...
export async function validateCreateWelcomeMessage(input: CreateWelcomeMessageInput) {
    await createWelcomeMessageSchema.validate(input, { abortEarly: false });
}

export async function validateChangeWelcomeMessage(input: ChangeWelcomeMessageInput) {
