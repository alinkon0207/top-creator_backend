...
export async function validateCreateScriptFolder(input: CreateScriptFolderInput) {
    await createScriptFolderSchema.validate(input, { abortEarly: false });
}

export async function validateUpdateScriptFolder(input: UpdateScriptFolderInput) {
