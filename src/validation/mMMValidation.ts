...
export async function validateCreateMassMessageForMessaging(input: Array<InputMaybe<CreateMassMessageInputForMessaging>>) {
    await createMassMessageForMessagingSchema.validate(input, {abortEarly: false});
}
