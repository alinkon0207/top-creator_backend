...
export async function validateCreateExpiringFansMessage(input: CreateExpiringFansMessageInput) {
    await createExpiringFansSchema.validate(input, { abortEarly: false });
}

export async function validateChangeExpiringFansMessage(input: ChangeExpiringFansMessageInput) {
